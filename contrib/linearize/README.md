# Linearize
Construct a linear, no-fork, best version of the Sfor blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install sfor_hash

https://github.com/sforpay/sfor_hash
...
JSON-RPC server. Running `sford` or `sfor-qt -server` will be sufficient.
...
* `input`: sford blocks/ directory containing blkNNNNN.dat
