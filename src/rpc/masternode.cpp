...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner Sfor address\n"
            "  payee          - Print the masternode payout Sfor address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the masternode operator public key\n"
            "  status         - Print masternode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the masternode voting Sfor address\n"
        );
}
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "sfor",               "masternode",             &masternode,             true,  {} },
    { "sfor",               "masternodelist",         &masternodelist,         true,  {} },
    { "sfor",               "getpoolinfo",            &getpoolinfo,            true,  {} },
#ifdef ENABLE_WALLET
    { "sfor",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
