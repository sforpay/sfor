...
This document provides guidelines for internationalization of the Sfor Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `sfor_en.ts` remains unchanged.
