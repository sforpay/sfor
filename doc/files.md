...
* sfor.conf: contains configuration settings for sford or sfor-qt
* sford.pid: stores the process id of sford while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by sford or sfor-qt
