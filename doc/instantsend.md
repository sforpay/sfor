...
This mechanism has been integrated into Bitcore-Node-Sfor which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/sforpay/insight-api-sfor#web-socket-api](https://github.com/sforpay/insight-api-sfor#web-socket-api)
* API: [https://github.com/sforpay/insight-api-sfor#instantsend-transactions](https://github.com/sforpay/insight-api-sfor#instantsend-transactions)
